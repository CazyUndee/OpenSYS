...
LOG = r"C:\Users\roone.DESKTOP-QK3UG2M\Downloads\projects\os\serial_heap.log"
PORT = 4445
...
try:
    ...
    print("\n=== Verification ===")
    checks = [
        ("heap listed in /proc", "heap" in log),
        ("Heap total line", "Heap total:" in log),
        ("Heap used line", "Heap used:" in log),
        ("Heap free line", "Heap free:" in log),
        ("Blocks line", "Blocks:" in log),
        ("Integrity OK", "Integrity:    OK" in log),
        ("meminfo still works", "MemTotal:" in log),
    ]
    all_pass = True
