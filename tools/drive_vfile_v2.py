...
try:
    ...
    checks = [
        ...
        ("/proc/self listed", "self" in log),
        ("/proc/self/pid returns PID", "/proc/self/pid" in log),
        ("/proc/self/name returns name", "/proc/self/name" in log),
        ("/proc/self/status has fields", "Name:" in log and "PID:" in log and "State:" in log),
        ("/proc/mounts shows ramfs", "ramfs" in log),
        ("/sys listing has devices", "devices" in log),
        ("/sys/devices/pci has Bus header", "Bus" in log),
