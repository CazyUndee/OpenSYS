...
NASMFLAGS = -f elf64
KERNEL = kernel64
SRCS = kernel64.c pmm64.c paging64.c kheap64.c fs.c gpt.c disk.c hid_keyboard.c shell.c vga.c io.c interrupt_handlers.c usb.c process.c scheduler.c vm.c elf.c syscall.c idt64.c gdt64.c tss.c user_bin.c pic.c
else
# 32-bit build
